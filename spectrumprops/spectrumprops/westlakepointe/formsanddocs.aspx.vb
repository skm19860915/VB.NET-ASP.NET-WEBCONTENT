...
Partial Class formsanddocsOfWestLakePointe
    ...
    Protected Sub groupsRep_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles groupsRep.ItemDataBound
        ...
        If groupLI IsNot Nothing Then
            ...
            Dim fileList As ListItemCollection = getDocListOfWestLakePointe(_files)
    ...
    Protected Function getDocListOfWestLakePointe(ByVal files() As String) As ListItemCollection
