<%@ Page Title="" Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" Inherits="spectrumprops.formsanddocsOfWestLakePointe" Codebehind="formsanddocs.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <hr />
    <div id="content">
	    <uc2:contentlabel ID="cl" filename="_formsanddoc_top.htm" runat="server" />
